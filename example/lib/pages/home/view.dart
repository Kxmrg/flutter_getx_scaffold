  ...
  Widget _buildDialogContent() {
    return RichTextX(children: [
      TextSpanItem('GetXScaffold',
          onTap: () => openWebPage('https://github.com/Kxmrg/flutter_getx_scaffold')),
      TextSpanItem('快速开发脚手架在'),
      TextSpanItem('GetX', onTap: () => openWebPage('https://github.com/jonataslaw/getx')),
      TextSpanItem(
          '框架和一些常用插件的基础上，构建了一套完整的快速开发模板。其中包括新增了部分常用功能的全局方法、常用的扩展方法和各种工具类、部分常用组件的封装、简单易用的对话框、二次封装的'),
      TextSpanItem('Dio', onTap: () => openWebPage('https://github.com/cfug/dio')),
      TextSpanItem('网络请求工具、二次封装的GetxController、二次封装的应用主题和国际化实现等。GetXScaffold是对以上这些内容的'),
